...
url = 'https://search-photos-wf47syehoy53qwgudl3fepdp2u.us-east-2.es.amazonaws.com/photos/_search'
...
def lambda_handler(event, context):
    ...
    r = requests.get(url, auth=HTTPBasicAuth("chenbowen", "428810cBW#"), data=json.dumps(params), headers=headers)
